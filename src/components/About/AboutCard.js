      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Bonjour à tous, je suis <span className="blue">Théo Guérin</span> de
          ...
          <ul>
            <li className="about-activity">✈️ • Voyager</li>
            <li className="about-activity">📷 • Prendre des photos</li>
            <li className="about-activity">🔭 • Astronomie</li>
            <li className="about-activity">🐈‍⬛ • M'occuper d'animaux</li>
          </ul>
        </blockquote>
      </Card.Body>
    </Card>
